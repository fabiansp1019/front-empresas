...
const header = (doc, empresa) => {
  ...
  doc.setFont("courier", "bold");
  doc.text(empresa?.estadosFinancieros?.aniio1, fila1, startY + 5, { align: "center" }); // 41
  doc.text(empresa?.estadosFinancieros?.aniio2, fila2, startY + 5, { align: "center" }); // 41
  doc.text(empresa?.estadosFinancieros?.aniio3, fila3, startY + 5, { align: "center" }); // 41
  doc.setFont("courier", "normal");
